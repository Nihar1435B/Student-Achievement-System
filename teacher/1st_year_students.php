...
<head>
    ...
    <title>Dashboard - 1st Year Students</title>
    ...
    <style>
        ...
        /* Styles for the dynamically loaded modal */
        ...
        <div class="flex-1 overflow-y-auto md:ml-64">
            ...
            <header class="sticky top-0 z-20 flex items-center justify-between border-b border-gray-200 bg-white p-4 shadow-sm">
                <div class="flex items-center">
                    ...
                    <h1 class="text-2xl font-bold text-gray-800">1st Year Students</h1>
                </div>
                        ...
                        <table class="w-full min-w-max text-left text-sm text-gray-700">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    // *** SQL Query for Year ***
                                    // For other files, change 'I' to 'II', 'III', 'IV', or 'V'
