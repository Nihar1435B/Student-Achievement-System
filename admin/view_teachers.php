...
<head>
    ...
    <title>Admin Dashboard - View Teachers</title>
...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen">
        <div id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 transform -translate-x-full overflow-y-auto bg-gray-900 p-4 transition-transform duration-300 ease-in-out md:translate-x-0">
            ...
            <nav class="flex flex-col space-y-2">
                ...
                <a href="teacher.html" class="group flex items-center rounded-lg bg-indigo-600 px-4 py-3 text-white transition-colors hover:bg-indigo-700"> <i class="fas fa-chalkboard-teacher mr-3 w-5 text-center"></i>
                    <span class="font-medium">Teacher</span>
                </a>
                <a href="../Achieve/main.php" class="group flex items-center rounded-lg px-4 py-3 text-gray-300 transition-colors hover:bg-gray-800 hover:text-white">
                    <i class="far fa-calendar-alt mr-3 w-5 text-center"></i>
                    <span class="font-medium">Achievement</span>
                </a>
            </nav>

            <div class="absolute bottom-0 left-0 w-full p-4">
                 <a href="login.html" class="group flex items-center rounded-lg px-4 py-3 text-gray-300 transition-colors hover:bg-red-700 hover:text-white">
        ...
        <div class="flex-1 overflow-y-auto md:ml-64">
            ...
            <header class="sticky top-0 z-20 flex items-center justify-between border-b border-gray-200 bg-white p-4 shadow-sm">
                ...
                <a href="login.html" class="hidden rounded-lg bg-red-600 px-5 py-2.5 text-sm font-medium text-white shadow-md transition-colors hover:bg-red-700 md:block">
                    Logout
                </a>
            </header>
            ...
            <div id="studentDetailsContent" class="p-6 md:p-8">
                ...
                <div id="detailsModal" class="relative overflow-x-auto bg-white p-6 shadow-lg rounded-xl">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                        <form onsubmit="searchTeachers(); return false;" class="flex-grow md:mr-4 mb-2 md:mb-0">
                            <div class="relative">
                                ...
                                <?php
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td class='px-6 py-4'>".$row['reg_no']."</td>";
                                            echo "<td class='px-6 py-4'>".$row['email']."</td>";
                                            
                                            // Action Buttons
                                            echo "<td class='px-6 py-4 text-center'>
                                                    <button onclick='viewDetails(".$row['teacher_id'].")' class='text-indigo-600 hover:text-indigo-900' title='View Details'>
                                                        <i class='fas fa-eye fa-lg'></i>
                                                    </button>
                                                  </td>";
                                            echo "<td class='px-6 py-4 text-center'>
                                                    <button onclick='deleteTeacher(".$row['teacher_id'].")' class='text-red-600 hover:text-red-900' title='Delete Teacher'>
                                        ...
                                        echo "<tr class='border-b bg-white'><td colspan='6' class='px-6 py-4 text-center text-gray-500'>No teachers found</td></tr>";
                                    }
    ...
    <script>
        ...
        // Function to view teacher details (loads new content via AJAX)
        ...
        function searchTeachers() { // Renamed from searchStudents
