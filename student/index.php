    ...
    <div class="flex h-screen">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 transform -translate-x-full overflow-y-auto bg-gray-900 p-4 transition-transform duration-300 ease-in-out md:translate-x-0">
            ...
            <div class="mb-8 flex flex-col items-center">
                ...
                <h3 class="text-xl font-semibold text-white">Student</h3>
                <span class="text-sm text-gray-400">Student Portal</span>
            </div>

            <!-- Navigation Links -->
            <nav class="flex flex-col space-y-2">
                <a href="index.php" class="group flex items-center rounded-lg bg-indigo-600 px-4 py-3 text-white transition-colors hover:bg-indigo-700">
        ...
        <div class="flex-1 overflow-y-auto md:ml-64">
            ...
            <main class="p-6 md:p-8">
                ...
                <!-- Announcement Box -->
                <div class="mt-8 rounded-lg bg-indigo-700 p-6 text-white shadow-xl">
                    <div class="flex items-center">
                        <i class="fas fa-bullhorn mr-4 text-3xl"></i>
                        <div>
                            <h4 class="text-xl font-bold">New Announcement</h4>
                            <p class="mt-1">New achievements can be viewed here. Click to see all updates!</p>
                        </div>
                    </div>
                    <!-- 
                        This div acts as the clickable "marquee" replacement.
                    -->
                    <div class="announcement-link mt-4 -m-6 rounded-lg p-6" 
                         onclick="window.location.href='../Achieve/main.php';" 
                         title="View Achievements">
                        <!-- This div creates an invisible overlay to make the whole box clickable -->
                    </div>
                </div>
